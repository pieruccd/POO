...
public class LecteurDonnees {
    ...
    private Robot lireRobot(int i, Carte map) throws DataFormatException {
        ...
        try {
            ...
            switch (type) {
                case "DRONE":
                    res = new Drone(map, pos, (s == null) ? 150 : Integer.parseInt(s), 10000);
                    break;
                case "ROUES":
                    res = new RobotARoues(map, pos, (s == null) ? 80 : Integer.parseInt(s), 5000);
                    break;
                case "PATTES":
                    res = new RobotAPattes(map, pos);
                    break;
                case "CHENILLES":
                    res = new RobotAChenilles(map, pos, (s == null) ? 60 : Integer.parseInt(s), 2000);
                    break;
                default:
